...
public class showBill extends javax.swing.JFrame {
    ...
    public void searchBid()
    {
        ...
        {
            setColumn();
            rs=con.createStatement().executeQuery("select * from Paid_tab where BID="+Integer.parseInt(jTextField1.getText())+"");
            int x=1;
            if(rs.next())
            {
              Vector v=new Vector();
            ...
            {
                JOptionPane.showMessageDialog(rootPane, "data is not available..!");
