 ...
 * @author mantu
 */
public class centry extends javax.swing.JFrame implements Printable{
    ...
    int mm,dd,yy;
    Calendar cal;
    public centry() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 0), "HEALTH & FITNESS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Agency FB", 1, 18), java.awt.Color.black)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new centry().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(centry.class.getName()).log(Level.SEVERE, null, ex);
