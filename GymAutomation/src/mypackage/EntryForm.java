...
public class EntryForm extends javax.swing.JFrame implements Printable{
  String mno,age,mid,mname,addr,gen=null,mst,nton,cast,cact,ogym,ptm,edt,gname,bg,occ,qual,pident,basis,lpd;
    double hei,wei,amnt;
    Connection con;
    Statement stm;
    ResultSet rs;
    ...
    public void setComponents()
    {
        ...
        jPanel5.setBounds(0, 0, this.getWidth(), this.getHeight());
        jPanel1.setBounds(0, 0, jPanel5.getWidth()-110, jPanel5.getHeight());
        jPanel2.setBounds(470, 20, 80, 200);
        //JOptionPane.showMessageDialog(rootPane, jPanel5.getWidth());
        jLabel23.setBounds(140, 15, 300, 30);
        jLabel24.setBounds(160, 30, 300, 30);
        jLabel1.setBounds(350, 5, 100, 120);
        jLabel2.setBounds(5, 5, 140, 120);
        jCheckBox1.setBounds(140, 70, 80, 20);
        jPanel1.add(jCheckBox1);
        jCheckBox2.setBounds(200, 70, 100, 20);
        jCheckBox3.setBounds(280, 70, 100, 20);
        jLabel3.setBounds(10, 120, 100, 30);
        jLabel4.setBounds(300, 120, 100, 30);
        jPanel1.add(jLabel4);
        jTextField2.setBounds(340, 120, 100, 30);
        jPanel1.add(jTextField2);
        jTextField1.setBounds(105, 120, 100, 30);
        jPanel1.add(jTextField1);
        jLabel5.setBounds(10, 150, 100, 20);
        jTextField3.setBounds(105, 150,334, 30);
        jPanel1.add(jTextField3);
        jLabel6.setBounds(10, 180, 140, 20);
        jTextField4.setBounds(105, 180, 334, 30);
        jPanel1.add(jTextField4);
        jLabel7.setBounds(10, 210, 100, 20);
        jTextField5.setBounds(105, 210, 334, 30);
        jPanel1.add(jTextField5);
        jLabel8.setBounds(10, 240, 80, 20);
        jTextField6.setBounds(105, 240, 100, 30);
        jPanel1.add(jTextField6);
        jLabel9.setBounds(300, 245, 100, 20);
        jTextField7.setBounds(340, 240, 100, 30);
        jPanel1.add(jTextField7);
        jPanel1.add(jLabel9);
        jLabel10.setBounds(10, 270, 80, 20);
        jTextField8.setBounds(105, 270, 334, 30);
        jPanel1.add(jTextField8);
        jLabel11.setBounds(10, 305, 80, 20);
        jTextField9.setBounds(105, 300, 334, 30);
        jPanel1.add(jTextField9);
        jLabel12.setBounds(10, 340, 80, 20);
        jCheckBox4.setBounds(105, 340, 80, 20);
        jCheckBox5.setBounds(160, 340, 80, 20);
        jPanel1.add(jCheckBox4);
        jLabel14.setBounds(300, 345, 80, 20);
        jTextField11.setBounds(340, 340, 100, 30);
        jPanel1.add(jTextField11);
        jPanel1.add(jLabel14);
        jLabel25.setBounds(276, 495, 100, 20);
        jComboBox1.setBounds(340, 490, 100, 30);
        jPanel1.add(jComboBox1);
        jPanel1.add(jLabel25);
        jPanel1.add(jCheckBox5);
        jLabel13.setBounds(10, 370, 80, 20);
        jTextField10.setBounds(105, 370, 100, 30);
        jPanel1.add(jTextField10);
        jLabel15.setBounds(10, 405, 80, 20);
        jTextField15.setBounds(105, 400, 100, 30);
        jLabel18.setBounds(219, 405,150, 20);
        jLabel20.setBounds(220, 435,150, 20);
        jLabel22.setBounds(296, 465, 150, 30);
        jTextField14.setBounds(340, 460, 100, 30);
        jPanel1.add(jTextField14);
        jPanel1.add(jLabel22);
        jTextField13.setBounds(285, 430,155, 30);
        jPanel1.add(jTextField13);
        jPanel1.add(jLabel20);
        jComboBox3.setBounds(340,400, 100, 30);
        jPanel1.add(jComboBox3);
        jPanel1.add(jLabel18);
        jLabel16.setBounds(239, 375, 100, 20);
        jComboBox2.setBounds(340, 370, 100, 30);
        jPanel1.add(jComboBox2);
        jPanel1.add(jLabel16);
        jPanel1.add(jTextField15);
        jLabel17.setBounds(10, 430, 80, 20);
        jTextField12.setBounds(105, 430, 100, 30);
        jPanel1.add(jTextField12);
        jLabel19.setBounds(10, 465, 140, 20);
        jComboBox4.setBounds(135, 460, 70, 30);
        jPanel1.add(jComboBox4);
        jLabel21.setBounds(10, 495, 80, 20);
        jComboBox5.setBounds(105, 490, 100, 30);
        jButton3.setBounds(0, 25, 50, 20);
        jButton4.setBounds(0, 115, 50, 20);
        jButton2.setBounds(0, 85, 50, 20);
        jButton5.setBounds(0, 55, 50, 20);
        jButton6.setBounds(0, 145, 50, 20);
        jButton7.setBounds(0, 175, 50, 20);
        ...
        jPanel1.add(jLabel3);
        jPanel1.add(jLabel5);
        jPanel3.setBounds(10, 520, 430, 200);
        jScrollPane2.setBounds(5, 20, jPanel3.getWidth()-20, jPanel3.getHeight()-20);
        //jTextArea1.setBounds(5, 10, jPanel3.getWidth(), jPanel3.getHeight());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "HEALTH & FITNESS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Agency FB", 1, 18), java.awt.Color.black)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mypackage/pp.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mypackage/log1.png"))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 0), "DECLARATION", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Arial", 1, 14), java.awt.Color.black)); // NOI18N

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 0), "WE CARE YOUR HEALTH", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_BOTTOM, new java.awt.Font("Arial Black", 1, 14), java.awt.Color.black)); // NOI18N
        ...
        jLabel25.setText("Joining Basis:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Monthly(32 Days)", "Quarterly(93 Days)", "Half yearly(186 days)", "Yearly (372 Days)", "Permanent", "Others", " ", " " }));
        ...
        jButton4.setToolTipText("All Fields Becomes Clear (Alt+c)");
        ...
        jButton6.setToolTipText("PRINT THE DOCUMENT(Alt+P)");
        ...
        jButton5.setToolTipText("Importing the text file(Alt+i)");
        ...
        jButton2.setToolTipText("Exporting the text File(Alt+x)");
        ...
        jButton3.setToolTipText("New Member Entry(Alt+e)");
        ...
        jButton7.setToolTipText("Exiting the form (Alt+T)");
    ...
    public void setData()//get the values of the fields
    {
        try{
            ...
            basis=(String)jComboBox1.getSelectedItem();
            lpd=jTextField2.getText();
    ...
    public void MembEntry()//new Member Entry 
    {
        try{
            setData();
            String sql="insert into Member_tab values('"+mid+"','"+mname+"','"+gname+"','"+addr+"','"+age+"','"+gen+"','"+mst+"','"+nton+"','"+cast+"','"+mno+"','"+cact+"','"+ogym+"','"+ptm+"',"+hei+","+wei+",#"+edt+"#,"+amnt+",'"+bg+"','"+path+"','"+occ+"','"+qual+"','"+pident+"','"+basis+"',#"+lpd+"#)";
